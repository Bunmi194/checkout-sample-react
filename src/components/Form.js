    ...
    render(){
        return(
            <>
                ...
                <div className="row">
                    <div className="col">
                        <Input name="expiry" title="Expiry date" type="text" value={this.state.expiryDate} placeholder="01/23" ref={this.expiryDateRef} handleChange={this.handleChangeExpiryDate}/>
                    </div>
                    <div className="col">
                ...
                <Link to="/success">     
                    <Checkout id="btncheckout" name="Pay" checkout={this.verifyMe}/>
                </Link>
